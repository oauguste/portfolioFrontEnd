                ...
                <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                  ...
                  <div className="sm:col-span-6">
                    ...
                    <p className="mt-2 text-sm leading-normal">
                      ...
                      production code for a diverse array of
                      projects for clients including Harvard
                      Business School, Everytown for Gun
                      Safety, Pratt Institute, Koala Health,
                      Vanderbilt University, The 19th News,
                      and more. Provide leadership within
